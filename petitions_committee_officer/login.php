                ...
                if ($stmt->rowCount() == 1) {
                    ...
                    if ($row = $stmt->fetch()) {
                        ...
                        if (password_verify($password, $hashed_password)) {
                            ...
                            header("Location: index.php?page=petitions_committee_officer/dashboard");
                            exit;
                        } else {
...
<!-- Header Template -->
<?= header_template('PETITIONS COMMITTEE OFFICER | LOGIN'); ?>
...
<div id="login_page">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h2>Petitions Committee Officer Login</h2>
                <hr>
                ...
                <form action="#" method="POST" class="login_form">
                    ...
                    <!-- <a href="index.php?page=petitions_committee_officer/register">Register</a> -->
